            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 14 }}>
              ...
              <tbody>
                {[
                  ...
                  ['Which page you opened and which booking links you clicked, how far through the planning questions you got (a question number, never your answers), your device type, and your country — worked out from your network address on our own servers and then discarded — against a daily code from that same address and your browser, never stored and different tomorrow', 'To count how many people visit, where they come from, where our planning questions lose people, and how many we send to a booking partner', 'Legitimate interest — you can object below', '12 months'],
