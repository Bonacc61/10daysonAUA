      ...
      <div className="container-1280" style={{ padding: '56px 36px 80px', maxWidth: 720 }}>
        ...
        <Section title="Third parties">
          <ul style={{ fontSize: 14, lineHeight: 1.7, paddingLeft: 20, margin: 0 }}>
            ...
            <li><strong>TransIP</strong> — Netherlands-based hosting &amp; email provider. <a href="https://www.transip.nl/privacy" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--red)' }}>transip.nl/privacy</a></li>
            <li><strong>Viator</strong> — activity booking affiliate links. Their privacy policy applies if you click through and book.</li>
          </ul>
        </Section>
