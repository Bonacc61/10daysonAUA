...
export const ITEM_PINS: Record<string, Pin> = {
  ...
  '33158P1': { coord: { lng: -70.005, lat: 12.5354 }, source: 'departure', place: 'Paradera', cite: 'OpenStreetMap node/4599172433, verified 2026-08-03 — meeting point per Viator: "You will see a sign of "Aruba Go Cherry" about 300 meters from Burger King Paradera. You can also find our exact locatio"' },  // Aruba Off-Road ATV Tour
  ...
  '419440P1': { coord: { lng: -69.9497, lat: 12.4526 }, source: 'departure', place: 'Savaneta', cite: 'OpenStreetMap node/4258604522, verified 2026-08-03 — meeting point per Viator: "We will meet the guests at the parking lot of Zeerovers Restaurant in Savaneta."' },  // Sea Glass Island Aruba Tour
