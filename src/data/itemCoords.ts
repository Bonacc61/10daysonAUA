...
export const ITEM_PINS: Record<string, Pin> = {
  ...
  '392509P1': { coord: { lng: -69.972, lat: 12.5322 }, source: 'departure', place: 'Ayo Rock Formation', cite: 'APPROX — the operator meets 400 m further along the road than this pin, by their own text. OpenStreetMap way/43109643 (park), verified 2026-08-03 — meeting point per Viator: "Our meeting point is on the same road of the Ayo Rock Formation, just a (1) minute drive or 1/4 miles (400 m) further to"', approx: true },  // Epic Off-Road Surron Electric Bike Tour in Aruba
  ...
  // retyped. Items absent from this list were reviewed and declined, or have no
  // determinable location; either way they draw no pin.
  '245504': { coord: { lng: -70.0109, lat: 12.576 }, source: 'known-place', place: 'Alto Vista Chapel', cite: 'OpenStreetMap node/540115823, verified 2026-08-03 — named as a stop in the Viator product description', stops: [{ coord: { lng: -69.8793, lat: 12.4137 }, place: 'Baby Beach', cite: 'OpenStreetMap node/10308886317, verified 2026-08-03' }, { coord: { lng: -70.0513, lat: 12.6138 }, place: 'California Lighthouse', cite: 'OpenStreetMap node/540121391, verified 2026-08-03' }, { coord: { lng: -69.9581, lat: 12.5408 }, place: 'Natural Bridge', cite: 'OpenStreetMap node/540233078, verified 2026-08-03' }] },  // Best of Aruba by Bus
  '137607P23': { coord: { lng: -70.0536, lat: 12.6099 }, source: 'known-place', place: 'Arashi Beach', cite: 'OpenStreetMap way/461766965, verified 2026-08-03 — named as a stop in the Viator product description', stops: [{ coord: { lng: -69.9695, lat: 12.4643 }, place: 'Mangel Halto', cite: 'OpenStreetMap way/463354307, verified 2026-08-03' }] },  // Aruba Private Luxury Boat Tours - Sail, Snorkel, Fishing and M
  '292552P1': { coord: { lng: -70.0594, lat: 12.5465 }, source: 'known-place', place: 'Eagle Beach', cite: 'OpenStreetMap way/25590792, verified 2026-08-03 — named as a stop in the Viator product description', stops: [{ coord: { lng: -70.049, lat: 12.5748 }, place: 'Palm Beach', cite: 'OpenStreetMap way/23060047, verified 2026-08-03' }] },  // Aruba Nightlife Party Bus Tour, Free Cocktails, Live DJ & Host
  '62666P3': { coord: { lng: -70.0366, lat: 12.5189 }, source: 'departure', place: 'Yemanja Woodfired Grill, Oranjestad', cite: 'APPROX — the meeting text names a street address this pin does not cover. OpenStreetMap node/4487848715, verified 2026-08-03 — meeting point per Viator: "The tour starts at Zoutmanstraat 1, right behind the Renaissance Hotel Marina Tower. You’ll find a small roundabout near"', approx: true },  // Aruba Food Fusion Tour: World Flavors to Savor
  '106422P2': { coord: { lng: -69.9695, lat: 12.4643 }, source: 'known-place', place: 'Mangel Halto', cite: 'OpenStreetMap way/463354307, verified 2026-08-03 — named as a stop in the Viator product description' },  // Aruba 2-Tank guided Dive for certified divers / own equipment
  '5595542P1': { coord: { lng: -70.0577, lat: 12.6021 }, source: 'known-place', place: 'SS Antilla wreck', cite: 'OpenStreetMap way/337807284, verified 2026-08-03 — named as a stop in the Viator product description', offshore: true, stops: [{ coord: { lng: -70.0519, lat: 12.6049 }, place: 'Boca Catalina', cite: 'OpenStreetMap way/690840582, verified 2026-08-03' }, { coord: { lng: -70.0513, lat: 12.6024 }, place: 'Tres Trapi', cite: 'OpenStreetMap node/4491605028, verified 2026-08-03' }] },  // 3 Hours Private Boat Includes Snorkeling & Swim with turtles
  '33158P1': { coord: { lng: -70.005, lat: 12.5354 }, source: 'departure', place: 'Paradera', cite: 'APPROX — district-level; the operator places it 300 m from a landmark this pin does not cover. OpenStreetMap node/4599172433, verified 2026-08-03 — meeting point per Viator: "You will see a sign of "Aruba Go Cherry" about 300 meters from Burger King Paradera. You can also find our exact locatio"', approx: true },  // Aruba Off-Road ATV Tour
  '377394P8': { coord: { lng: -70.047, lat: 12.5298 }, source: 'departure', place: 'Schotlandstraat, Oranjestad', cite: 'APPROX — street/area level, not the doorway. OpenStreetMap: Schotlandstraat, Madiki/Bushiri, Oranjestad West (residential road), verified 2026-08-03 (street level — no house-number data exists for Aruba) — meeting point per Viator: "We start the tour from Schotlandstraat 46, Oranjestad. Customers that come to our office by themself. Please, park at th"', approx: true },  // 4-seater UTV Island 4hr Tour in Aruba, morning or afternoon
  '6687ATV': { coord: { lng: -70.0109, lat: 12.576 }, source: 'known-place', place: 'Alto Vista Chapel', cite: 'OpenStreetMap node/540115823, verified 2026-08-03 — named as a stop in the Viator product description', stops: [{ coord: { lng: -69.9766, lat: 12.5537 }, place: 'Bushiribana Gold Mill Ruins', cite: 'OpenStreetMap way/79210010, verified 2026-08-03' }, { coord: { lng: -69.9581, lat: 12.5408 }, place: 'Natural Bridge', cite: 'OpenStreetMap node/540233078, verified 2026-08-03' }] },  // Aruba North Coast ATV Desert Adventure
  '200215P1': { coord: { lng: -69.9785, lat: 12.5466 }, source: 'departure', place: 'Aruba Ostrich Farm', cite: 'APPROX — the meeting text names a street address this pin does not cover. OpenStreetMap way/377194991 (zoo), verified 2026-08-03 — meeting point per Viator: "We are located on the road to the natural bridge and Bushiribana Gold mill ruins. Our address is Matividiri 60. Please a"', approx: true },  // Aruba's Northern Coast Horseback Adventure
  '6593P14': { coord: { lng: -70.0461, lat: 12.5744 }, source: 'departure', place: 'Pelican Pier', cite: 'OpenStreetMap way/555476889, verified 2026-08-03 — meeting point per Viator: "Check-in is at 5:00 P.M. at the front desk of the Pelican Pier located between the Holiday Inn & Playa Linda Beach Resor"' },  // Salsa, Sunsets & Mojitos at Sea
  '419440P1': { coord: { lng: -69.9497, lat: 12.4526 }, source: 'departure', place: 'Savaneta', cite: 'APPROX — village-level; the meeting point is one named car park inside it, which this pin does not resolve. OpenStreetMap node/4258604522, verified 2026-08-03 — meeting point per Viator: "We will meet the guests at the parking lot of Zeerovers Restaurant in Savaneta."', approx: true },  // Sea Glass Island Aruba Tour
  '47774P3': { coord: { lng: -69.9766, lat: 12.5537 }, source: 'known-place', place: 'Bushiribana Gold Mill Ruins', cite: 'OpenStreetMap way/79210010, verified 2026-08-03 — named as a stop in the Viator product description', stops: [{ coord: { lng: -70.0513, lat: 12.6138 }, place: 'California Lighthouse', cite: 'OpenStreetMap node/540121391, verified 2026-08-03' }] },  // Aruba UTV & ATV Adventure
  '39473P5': { coord: { lng: -70.0109, lat: 12.576 }, source: 'known-place', place: 'Alto Vista Chapel', cite: 'OpenStreetMap node/540115823, verified 2026-08-03 — named as a stop in the Viator product description', stops: [{ coord: { lng: -69.9766, lat: 12.5537 }, place: 'Bushiribana Gold Mill Ruins', cite: 'OpenStreetMap way/79210010, verified 2026-08-03' }, { coord: { lng: -70.0513, lat: 12.6138 }, place: 'California Lighthouse', cite: 'OpenStreetMap node/540121391, verified 2026-08-03' }, { coord: { lng: -69.9581, lat: 12.5408 }, place: 'Natural Bridge', cite: 'OpenStreetMap node/540233078, verified 2026-08-03' }, { coord: { lng: -70.0513, lat: 12.6024 }, place: 'Tres Trapi', cite: 'OpenStreetMap node/4491605028, verified 2026-08-03' }, { coord: { lng: -69.9852, lat: 12.559 }, place: 'Wariruri Bay', cite: 'OpenStreetMap relation/14759456, verified 2026-08-03' }] },  // UTV Morning Tour: Discover Aruba's Hidden Treasures
  '13835P20': { coord: { lng: -70.0594, lat: 12.5465 }, source: 'known-place', place: 'Eagle Beach', cite: 'OpenStreetMap way/25590792, verified 2026-08-03 — named as a stop in the Viator product description', stops: [{ coord: { lng: -70.049, lat: 12.5748 }, place: 'Palm Beach', cite: 'OpenStreetMap way/23060047, verified 2026-08-03' }] },  // Horseback Riding 2 Hr SUNSET , Rock formation & North Coast Ri
  '47774P7': { coord: { lng: -69.9766, lat: 12.5537 }, source: 'known-place', place: 'Bushiribana Gold Mill Ruins', cite: 'OpenStreetMap way/79210010, verified 2026-08-03 — named as a stop in the Viator product description' },  // Aruba Safari Jeep Tour and Beach Cliff Jumping
  '300281P10': { coord: { lng: -69.9444, lat: 12.4447 }, source: 'departure', place: 'Flying Fishbone', cite: 'OpenStreetMap way/376319912 (restaurant), verified 2026-08-03 — meeting point per Viator: "Our meeting point is next to Flying Fishbone at the boat ramp. In case of strong wind or rough seas, we may depart from "' },  // Discover Sea Glass Island: Aruba’s Must-Do Adventure
  '39473P6': { coord: { lng: -70.0109, lat: 12.576 }, source: 'known-place', place: 'Alto Vista Chapel', cite: 'OpenStreetMap node/540115823, verified 2026-08-03 — named as a stop in the Viator product description', stops: [{ coord: { lng: -69.9558, lat: 12.5375 }, place: 'Andicuri Beach', cite: 'OpenStreetMap way/339090140, verified 2026-08-03' }, { coord: { lng: -69.9766, lat: 12.5537 }, place: 'Bushiribana Gold Mill Ruins', cite: 'OpenStreetMap way/79210010, verified 2026-08-03' }, { coord: { lng: -69.9695, lat: 12.4643 }, place: 'Mangel Halto', cite: 'OpenStreetMap way/463354307, verified 2026-08-03' }, { coord: { lng: -69.9581, lat: 12.5408 }, place: 'Natural Bridge', cite: 'OpenStreetMap node/540233078, verified 2026-08-03' }] },  // Aruba Northcoast UTV Afternoon Tour
  '186518P4': { coord: { lng: -69.9755, lat: 12.4696 }, source: 'departure', place: 'Marina Pirata', cite: 'OpenStreetMap way/376285540 (restaurant), verified 2026-08-03 — meeting point per Viator: "200 feet from Marina Pirata Restaurant, Nautilus Dive Center. PADI FLAG"' },  // Aruba PADI Scuba Diving Program Non Certified Divers
  '13835P11': { coord: { lng: -70.032, lat: 12.585 }, source: 'departure', place: 'Rancho Notorious', cite: 'OpenStreetMap way/641456655, verified 2026-08-03 — meeting point per Viator: "We recommend navigating directly to "Rancho Notorious" using Google Maps or Waze."' },  // Aruba Horseback Riding Tour For Advanced Riders
  '13835P3': { coord: { lng: -70.0436, lat: 12.5212 }, source: 'departure', place: 'Cruise Terminal, Oranjestad', cite: 'APPROX — street/area level, not the doorway. OpenStreetMap: Cruise Ship Dock, Oranjestad, verified 2026-08-03 (meeting point is across the street, so ~100m) — meeting point per Viator: "Please look for reconfirmation email from us with the exact time to wait outside the lobby of your hotel. Cruise ship gu"', approx: true },  // Aruba Countryside: Horseback Adventure to Urirama Cove
  '5494168P1': { coord: { lng: -70.049, lat: 12.5748 }, source: 'departure', place: 'Palm Beach', cite: 'APPROX — the meeting text names a street address this pin does not cover. OpenStreetMap way/23060047, verified 2026-08-03 — meeting point per Viator: "Noord 23, Palm Beach Aruba"', approx: true },  // Guided Trikes Tour Around Aruba Island
  '39473P2': { coord: { lng: -70.0109, lat: 12.576 }, source: 'known-place', place: 'Alto Vista Chapel', cite: 'OpenStreetMap node/540115823, verified 2026-08-03 — named as a stop in the Viator product description', stops: [{ coord: { lng: -70.0513, lat: 12.6138 }, place: 'California Lighthouse', cite: 'OpenStreetMap node/540121391, verified 2026-08-03' }] },  // Aruba Countryside Tour
  '106422P3': { coord: { lng: -69.9695, lat: 12.4643 }, source: 'known-place', place: 'Mangel Halto', cite: 'OpenStreetMap way/463354307, verified 2026-08-03 — named as a stop in the Viator product description' },  // Aruba 2-Tank Guided Dive for Certified Divers / rental equipme
  '15815P2': { coord: { lng: -70.0136, lat: 12.4958 }, source: 'departure', place: 'Bucutiweg', cite: 'APPROX — street/area level, not the doorway. OpenStreetMap way/40957323 (tertiary), verified 2026-08-03 (street/area level — accurate to the block, not the doorway) — meeting point per Viator: "Use Google Maps or maps.me for easier navigation by placing our address BUCUTIWEG 20. Parking is available and free of c"', approx: true },  // Aruba 2-Tank Dive Excursion for Certified Divers
  '13835P15': { coord: { lng: -70.032, lat: 12.585 }, source: 'departure', place: 'Rancho Notorious', cite: 'OpenStreetMap way/641456655, verified 2026-08-03 — meeting point per Viator: "We recommend navigating directly to "Rancho Notorious" using Google Maps or Waze."' },  // Sunset Horseback Ride in Aruba
  '292552P5': { coord: { lng: -69.9766, lat: 12.5537 }, source: 'known-place', place: 'Bushiribana Gold Mill Ruins', cite: 'OpenStreetMap way/79210010, verified 2026-08-03 — named as a stop in the Viator product description', stops: [{ coord: { lng: -69.9695, lat: 12.4643 }, place: 'Mangel Halto', cite: 'OpenStreetMap way/463354307, verified 2026-08-03' }] },  // Aruba Private Full Island Tour
  '13835P17': { coord: { lng: -70.032, lat: 12.585 }, source: 'departure', place: 'Rancho Notorious', cite: 'OpenStreetMap way/641456655, verified 2026-08-03 — meeting point per Viator: "We recommend navigating directly to "Rancho Notorious" using Google Maps or Waze."' },  // Aruba Private, 2 Hour Horseback Riding Tour For Advanced Rider
  '300281P7': { coord: { lng: -69.9444, lat: 12.4447 }, source: 'departure', place: 'Flying Fishbone', cite: 'OpenStreetMap way/376319912 (restaurant), verified 2026-08-03 — meeting point per Viator: "Our meeting point is at the right next to Flying Fishbone at the boat ramp. In case of strong wind or rough seas, we may"' },  // Sunset Sea Glass Island Kayak Tour
  '13835P1': { coord: { lng: -70.032, lat: 12.585 }, source: 'departure', place: 'Rancho Notorious', cite: 'OpenStreetMap way/641456655, verified 2026-08-03 — meeting point per Viator: "We recommend navigating directly to "Rancho Notorious" using Google Maps or Waze."' },  // Aruba Horseback Riding Tour to Hidden Lagoon
  '137607P22': { coord: { lng: -70.0461, lat: 12.5744 }, source: 'departure', place: 'Pelican Pier', cite: 'OpenStreetMap way/555476889, verified 2026-08-03 — meeting point per Viator: "Kiosk of Around Aruba Tours behind Aruba Marriott Resort & Stellaris Casino near Antilles Beach Bar on the backside/beac"' },  // Aruba Jet Ski Rental — Exciting Water Adventures Await
  '6841P6': { coord: { lng: -70.047, lat: 12.5298 }, source: 'departure', place: 'Schotlandstraat, Oranjestad', cite: 'APPROX — street/area level, not the doorway. OpenStreetMap: Schotlandstraat, Madiki/Bushiri, Oranjestad West (residential road), verified 2026-08-03 (street level — no house-number data exists for Aruba) — meeting point per Viator: "Cruise passengers are welcome to join the tour. Please check your ship’s arrival time to ensure you’ll have sufficient t"', approx: true },  // Aruba UTV Off-Road Driving Experience North Coast Stops
  '122173P3': { coord: { lng: -69.9444, lat: 12.4447 }, source: 'departure', place: 'Flying Fishbone', cite: 'OpenStreetMap way/376319912 (restaurant), verified 2026-08-03 — meeting point per Viator: "The meeting point is located at the small pier right next to Villa Rossana in Savaneta. It is very close to the Flying F"' },  // Kayak Tour to Seaglass Island
  '70453P2': { coord: { lng: -70.0536, lat: 12.6099 }, source: 'departure', place: 'Arashi Beach', cite: 'OpenStreetMap way/461766965, verified 2026-08-03 — meeting point per Viator: "Meeting time 5.45 pm at Arashi Beach Departure Time 6 pm at Arashi Beach Clear Kayak Aruba DOES NOT have a booth on Aras"' },  // Aruba Night Glass Kayak Tour
  '70453P1': { coord: { lng: -69.9695, lat: 12.4643 }, source: 'known-place', place: 'Mangel Halto', cite: 'OpenStreetMap way/463354307, verified 2026-08-03 — named as a stop in the Viator product description' },  // Aruba Glass Bottom Kayak Tour through the Mangrove Forest
  '358117P10': { coord: { lng: -69.9497, lat: 12.4526 }, source: 'departure', place: 'Savaneta', cite: 'OpenStreetMap node/4258604522, verified 2026-08-03 — meeting point per Viator: "On the right off Savaneta 284 villa Rossana you will see an abandoned house.Right behind it there’s a ramp where we laun"' },  // Sea Glass Island Tour By Boat
  '19808P5': { coord: { lng: -69.9766, lat: 12.5537 }, source: 'known-place', place: 'Bushiribana Gold Mill Ruins', cite: 'OpenStreetMap way/79210010, verified 2026-08-03 — named as a stop in the Viator product description', stops: [{ coord: { lng: -69.9695, lat: 12.4643 }, place: 'Mangel Halto', cite: 'OpenStreetMap way/463354307, verified 2026-08-03' }, { coord: { lng: -69.9581, lat: 12.5408 }, place: 'Natural Bridge', cite: 'OpenStreetMap node/540233078, verified 2026-08-03' }] },  // Half-Day Aruba UTV Adventure Tour
  '367744P1': { coord: { lng: -70.0536, lat: 12.6099 }, source: 'known-place', place: 'Arashi Beach', cite: 'OpenStreetMap way/461766965, verified 2026-08-03 — named as a stop in the Viator product description', stops: [{ coord: { lng: -70.0594, lat: 12.5465 }, place: 'Eagle Beach', cite: 'OpenStreetMap way/25590792, verified 2026-08-03' }, { coord: { lng: -69.9581, lat: 12.5408 }, place: 'Natural Bridge', cite: 'OpenStreetMap node/540233078, verified 2026-08-03' }] },  // Half-Day Aruba Sightseeing Tour & Beach in an Air-condition Bu
  '283728P3': { coord: { lng: -70.0441, lat: 12.5829 }, source: 'departure', place: 'The Ritz-Carlton, Aruba', cite: 'APPROX — pinned at the named hotel; the pier sits ~150-200m seaward. OpenStreetMap way/370096811, verified 2026-08-03 — meeting point per Viator: "if you pass the Ritz Carlton on your left hand side, look out for the big BLUE building on your left hand. There we are "', approx: true },  // Private Mountain Bike Tour in Aruba
  '5599636P2': { coord: { lng: -70.0594, lat: 12.5465 }, source: 'departure', place: 'Eagle Beach', cite: 'OpenStreetMap way/25590792, verified 2026-08-03 — meeting point per Viator: "You can find us on Eagle Beach, directly across from La Quinta Beach Resort. Just look for our setup on the beach—we\'ll "' },  // Sip and Paint Aruba Sunset Creative Experience
  '292552P14': { coord: { lng: -70.049, lat: 12.5748 }, source: 'known-place', place: 'Palm Beach', cite: 'OpenStreetMap way/23060047, verified 2026-08-03 — named as a stop in the Viator product description' },  // Sunset Party Bus tour with Champagne toast on the beach & Kara
  '472918P1': { coord: { lng: -70.0519, lat: 12.6049 }, source: 'departure', place: 'Boca Catalina', cite: 'OpenStreetMap way/690840582, verified 2026-08-03 — meeting point per Viator: "Boca Catalina beach We’ll message you 24 hours before your tour with the exact meeting point (Google Maps pin), parking/"' },  // Award-Winning Private Turtle Snorkeling Aruba | Video Included
  '2455P17': { coord: { lng: -70.05, lat: 12.5637 }, source: 'known-place', place: 'The Butterfly Farm', cite: 'OpenStreetMap way/38451837, verified 2026-08-03 — named as a stop in the Viator product description', stops: [{ coord: { lng: -70.0513, lat: 12.6138 }, place: 'California Lighthouse', cite: 'OpenStreetMap node/540121391, verified 2026-08-03' }, { coord: { lng: -69.9581, lat: 12.5408 }, place: 'Natural Bridge', cite: 'OpenStreetMap node/540233078, verified 2026-08-03' }] },  // Aruba Sightseeing Tour with Transport
  '400174P2': { coord: { lng: -70.0505, lat: 12.5645 }, source: 'departure', place: 'Signature Park', cite: 'OpenStreetMap way/685527702 (park), verified 2026-08-03 — meeting point per Viator: "We will meet at Signature Park Aruba in front of a Blue Building"' },  // #1Clear Kayak Aruba Shoot| FREE Cocktail|Edits 24hr|+Free Coup
};
