...
export const ACTIVITIES: Activity[] = [
  ...
  { id: 'arikok-hiking', title: 'Arikok National Park Hike', category: 'Activities', image: '/Arikok National Park Hike.jpg', description: '20% of the island. Limestone cliffs, natural pools, ancient cave paintings, and the dramatic northeast coast. Self-guided trails — no tour needed.', localsSay: '"Most tourists never leave Palm Beach. Arikok shows you what Aruba actually is." — Danilo', cost: '$11 entry', duration: '3–5 hrs', timeOfDay: 'Morning', fitReason: 'Nature & adventure', location: 'Arikok National Park', rating: 4.7, reviewCount: 934, adventure: 55, sections: ['adventures-outdoor'], matched_by: [] },
  { id: 'california-lighthouse-sunset', title: 'California Lighthouse Sunset', category: 'Beaches', image: '/California Lighthouse Sunset.jpg', description: "Northernmost point of the island, perfect golden-hour cliffside views. Tonight's sunset is at 6:42pm — arrive 30 min early.", localsSay: '"This is the spot for any first-night couple." — Jana', cost: 'Free', duration: '1–2 hrs', timeOfDay: 'Evening', fitReason: "Locals' sunset spot", location: 'Hudishibana, Noord', rating: 4.7, reviewCount: 1289, adventure: 8, sections: ['beaches'], matched_by: [] },
