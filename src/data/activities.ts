...
export const ACTIVITIES: Activity[] = [
  ...
  { id: 'kitesurfing-lesson', title: "Kitesurfing at Fisherman's Huts", category: 'Watersports', image: 'https://images.pexels.com/photos/2179473/pexels-photo-2179473.jpeg?auto=compress&cs=tinysrgb&w=800', description: "Constant 15–25 knot trade winds, shallow flat water. Aruba is one of the world's top kite spots.", localsSay: '"Consistent wind 320+ days a year." — Sven', cost: '$120 lesson', duration: '2–3 hrs', timeOfDay: 'Afternoon', fitReason: 'World-class kite conditions', location: "Fisherman's Huts, Malmok", rating: 4.8, reviewCount: 654 },
  { id: 'natural-pool-jeep', title: 'Conchi Natural Pool Jeep Tour', category: 'Tours', image: 'https://images.pexels.com/photos/1125883/pexels-photo-1125883.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Lava-ringed cove on the wild northeast coast, only reachable by 4WD or a 2-hour hike.', localsSay: '"Not easy to get to. That\'s the whole point." — Marco', cost: '$75 pp', duration: '3–5 hrs', timeOfDay: 'Morning', fitReason: 'Off-the-beaten-path adventure', location: 'Arikok', rating: 4.9, reviewCount: 1102 },
];
...
export const SAMPLE_ITINERARY: Day[] = [
  { day: 1, title: 'Arrive & Orient',   color: '#FF6B47', morning: 'eagle-beach-morning',  afternoon: null,                evening: 'california-lighthouse-sunset' },
  { day: 2, title: 'Reef & Ruins',      color: '#3B82F6', morning: 'boca-catalina-snorkel', afternoon: 'oranjestad-walking', evening: 'antilla-wreck-dive' },
  { day: 3, title: 'Wild Aruba',        color: '#22C55E', morning: 'arikok-hiking',        afternoon: 'natural-pool-jeep', evening: 'zeerovers-fresh-catch' },
  { day: 4, title: 'Beach & Flamingos', color: '#EAB308', morning: 'flamingo-renaissance', afternoon: 'baby-beach-snorkel', evening: 'gasparito-restaurant' },
  { day: 5, title: 'Wind & Farewell',   color: '#E63946', morning: 'kitesurfing-lesson',   afternoon: null,                evening: 'california-lighthouse-sunset' },
];
...
export const FAQ_ITEMS: FAQItem[] = [
  ...
  { q: 'What does it cost?', a: "The plan is free. If you book accommodation, activities, or rentals through our links, prices match what you'd see direct on the partner site." },
