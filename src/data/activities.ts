...
export const ACTIVITIES: Activity[] = [
  { id: 'eagle-beach-morning', title: 'Eagle Beach Sunrise Session', category: 'Beaches', image: 'https://images.pexels.com/photos/1450340/pexels-photo-1450340.jpeg?auto=compress&cs=tinysrgb&w=800', description: "Consistently voted one of the Caribbean's top beaches. Wide, powdery sand — uncrowded before 9am. Find a spot under a divi-divi tree.", localsSay: '"Skip the hotel beach. Eagle Beach before breakfast is one of those mornings you\'ll remember for years." — Rosario', cost: 'Free', duration: '2–3 hrs', timeOfDay: 'Morning', fitReason: 'Quiet start for day 1', location: 'Eagle Beach, Noord', rating: 4.9, reviewCount: 2847, adventure: 8, sections: ['beaches'], matched_by: [] },
  ...
  { id: 'arikok-hiking', title: 'Arikok National Park Guided Hike', category: 'Activities', image: 'https://images.pexels.com/photos/618833/pexels-photo-618833.jpeg?auto=compress&cs=tinysrgb&w=800', description: '20% of the island. Limestone cliffs, natural pools, ancient cave paintings, and the dramatic northeast coast.', localsSay: '"Most tourists never leave Palm Beach. Arikok shows you what Aruba actually is." — Danilo', cost: '$11 + $45 tour', duration: '3–5 hrs', timeOfDay: 'Morning', fitReason: 'Nature & adventure', location: 'Arikok National Park', rating: 4.7, reviewCount: 934, adventure: 55, sections: ['adventures-outdoor'], matched_by: [] },
  { id: 'california-lighthouse-sunset', title: 'California Lighthouse Sunset', category: 'Beaches', image: 'https://images.pexels.com/photos/1252500/pexels-photo-1252500.jpeg?auto=compress&cs=tinysrgb&w=800', description: "Northernmost point of the island, perfect golden-hour cliffside views. Tonight's sunset is at 6:42pm — arrive 30 min early.", localsSay: '"This is the spot for any first-night couple." — Jana', cost: 'Free', duration: '1–2 hrs', timeOfDay: 'Evening', fitReason: "Locals' first-night spot", location: 'Hudishibana, Noord', rating: 4.7, reviewCount: 1289, adventure: 8, sections: ['beaches'], matched_by: [] },
  ...
  { id: 'antilla-wreck-dive', title: 'Antilla Shipwreck Dive', category: 'Watersports', image: 'https://images.pexels.com/photos/1645028/pexels-photo-1645028.jpeg?auto=compress&cs=tinysrgb&w=800', description: '400-foot WWII German freighter scuttled in 1940. Upper sections sit in 60 feet — accessible to Open Water divers.', localsSay: '"World-class. Different every dive." — Ramon', cost: '$85 2-tank', duration: '3–4 hrs', timeOfDay: 'Morning', fitReason: 'Because you asked for wrecks', location: 'Off Malmok Beach', rating: 4.9, reviewCount: 876, adventure: 60, sections: ['cruises-water'], matched_by: [] },
  ...
  { id: 'kitesurfing-lesson', title: "Kitesurfing at Fisherman's Huts", category: 'Watersports', image: 'https://images.pexels.com/photos/2179473/pexels-photo-2179473.jpeg?auto=compress&cs=tinysrgb&w=800', description: "Constant 15–25 knot trade winds, shallow flat water. Aruba is one of the world's top kite spots.", localsSay: '"Consistent wind 320+ days a year." — Sven', cost: '$120 lesson', duration: '2–3 hrs', timeOfDay: 'Afternoon', fitReason: 'World-class kite conditions', location: "Fisherman's Huts, Malmok", rating: 4.8, reviewCount: 654, adventure: 85, sections: ['cruises-water'], matched_by: [] },
  { id: 'natural-pool-jeep', title: 'Conchi Natural Pool Jeep Tour', category: 'Tours', image: 'https://images.pexels.com/photos/1125883/pexels-photo-1125883.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Lava-ringed cove on the wild northeast coast, only reachable by 4WD or a 2-hour hike.', localsSay: '"Not easy to get to. That\'s the whole point." — Marco', cost: '$75 pp', duration: '3–5 hrs', timeOfDay: 'Morning', fitReason: 'Off-the-beaten-path adventure', location: 'Arikok', rating: 4.9, reviewCount: 1102, adventure: 70, sections: ['adventures-outdoor'], matched_by: [] },
