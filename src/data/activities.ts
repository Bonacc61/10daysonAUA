...
export const ACTIVITIES: Activity[] = [
  ...
  { id: 'san-nicolas-murals', title: 'San Nicolas Mural Walk', requires_car: true, category: 'Tours', image: '/San Nicolas Murals.jpg', description: "The old refinery town turned open-air gallery — dozens of large-scale murals across a few walkable blocks, plus Aruba's oldest bars. Self-guided, or join a walking tour.", localsSay: '', cost: 'Free', duration: '2–3 hrs', timeOfDay: 'Morning', fitReason: 'Street art and real town life', location: 'San Nicolas', rating: 4.6, reviewCount: 0, adventure: 10, sections: ['culture-history'], matched_by: [] },
];
