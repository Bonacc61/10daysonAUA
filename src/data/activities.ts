...
export const ACTIVITIES: Activity[] = [
  ...
  { id: 'california-lighthouse-sunset', title: 'California Lighthouse Sunset', category: 'Beaches', image: 'https://images.pexels.com/photos/1252500/pexels-photo-1252500.jpeg?auto=compress&cs=tinysrgb&w=800', description: "Northernmost point of the island, perfect golden-hour cliffside views. Tonight's sunset is at 6:42pm — arrive 30 min early.", localsSay: '"This is the spot for any first-night couple." — Jana', cost: 'Free', duration: '1–2 hrs', timeOfDay: 'Evening', fitReason: "Locals' sunset spot", location: 'Hudishibana, Noord', rating: 4.7, reviewCount: 1289, adventure: 8, sections: ['beaches'], matched_by: [] },
  ...
  { id: 'natural-pool-jeep', title: 'Natural Pool & Indian Cave Jeep Safari', category: 'Tours', image: 'https://images.pexels.com/photos/1125883/pexels-photo-1125883.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Lava-ringed cove on the wild northeast coast, only reachable by 4WD or a 2-hour hike.', localsSay: '"Not easy to get to. That\'s the whole point." — Marco', cost: '$75 pp', duration: '3–5 hrs', timeOfDay: 'Morning', fitReason: 'Off-the-beaten-path adventure', location: 'Arikok', rating: 4.9, reviewCount: 1102, adventure: 70, sections: ['adventures-outdoor'], matched_by: [] },
