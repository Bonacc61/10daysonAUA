...
export const ACTIVITIES: Activity[] = [
  ...
  { id: 'arashi-beach', title: 'Arashi Beach', requires_car: true, category: 'Beaches', image: '/Arashi Beach.jpg', description: "The last beach before the island's northwest tip — calm, shallow and sandy, with a reef close enough to swim to. Palapas, a snack bar, and none of the high-rise crowd.", localsSay: '', cost: 'Free', duration: '2–3 hrs', timeOfDay: 'Morning', fitReason: 'Calm snorkel beach, no crowds', location: 'Arashi, Noord', rating: 4.7, reviewCount: 0, adventure: 12, sections: ['beaches'], tags: [11912], matched_by: [] },
  { id: 'palm-beach-strip', title: 'Palm Beach', category: 'Beaches', image: '/Palm Beach.jpg', description: 'The wide, hotel-lined stretch north of Eagle — flat water, watersports desks, and the pier bars. Busiest beach on the island, and the easiest one to spend a whole afternoon on.', localsSay: '', cost: 'Free', duration: '2–4 hrs', timeOfDay: 'Afternoon', fitReason: 'Everything within walking distance', location: 'Palm Beach, Noord', rating: 4.6, reviewCount: 0, adventure: 6, sections: ['beaches'], matched_by: [] },
  { id: 'boca-catalina-shore', title: 'Boca Catalina Shore Snorkel', requires_car: true, category: 'Beaches', image: '/Boca Catalina.jpg', description: 'A small rocky cove between Malmok and Arashi where the catamarans anchor offshore. Walk in from the road, swim out twenty metres, and the fish are already there — no boat needed.', localsSay: '', cost: 'Free + $10 rental', duration: '1–3 hrs', timeOfDay: 'Morning', fitReason: 'Boat-free reef access', location: 'Boca Catalina, Malmok', rating: 4.7, reviewCount: 0, adventure: 22, sections: ['beaches'], tags: [11912], matched_by: [] },
