...
export const ACTIVITIES: Activity[] = [
  ...
  { id: 'rodgers-beach', title: "Rodger's Beach", category: 'Beaches', image: '/Rodgers Beach.png', description: 'A calm crescent right next to Baby Beach, framed by the old refinery hills. Glassy water, a local snack truck, and a fraction of the crowds.', localsSay: '"Everyone piles into Baby Beach. Rodger\'s, right next door, is where San Nicolas actually swims." — Ditmar', cost: 'Free', duration: '2–3 hrs', timeOfDay: 'Afternoon', fitReason: 'Calm, uncrowded south', location: 'Seroe Colorado, San Nicolas', rating: 4.6, reviewCount: 717, adventure: 8, sections: ['beaches'], matched_by: [] },
