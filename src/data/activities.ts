...
export const ACTIVITIES: Activity[] = [
  ...
  { id: 'arashi-beach', title: 'Arashi Beach', requires_car: true, category: 'Beaches', image: '/Arashi Beach.png', description: "The last beach before the island's northwest tip — calm, shallow and sandy, with a reef close enough to swim to. Palapas, a snack bar, and none of the high-rise crowd.", localsSay: '', cost: 'Free', duration: '2–3 hrs', timeOfDay: 'Morning', fitReason: 'Calm snorkel beach, no crowds', location: 'Arashi, Noord', rating: 4.7, reviewCount: 0, adventure: 12, sections: ['beaches'], tags: [11912], matched_by: [] },
  { id: 'palm-beach-strip', title: 'Palm Beach', category: 'Beaches', image: '/Palm Beach afternoon.png', description: 'The wide, hotel-lined stretch north of Eagle — flat water, watersports desks, and the pier bars. Busiest beach on the island, and the easiest one to spend a whole afternoon on.', localsSay: '', cost: 'Free', duration: '2–4 hrs', timeOfDay: 'Afternoon', fitReason: 'Everything within walking distance', location: 'Palm Beach, Noord', rating: 4.6, reviewCount: 0, adventure: 6, sections: ['beaches'], matched_by: [] },
  { id: 'boca-catalina-shore', title: 'Boca Catalina Shore Snorkel', requires_car: true, category: 'Beaches', image: '/Boca Catalina Beach.png', description: 'A small rocky cove between Malmok and Arashi where the catamarans anchor offshore. Walk in from the road, swim out twenty metres, and the fish are already there — no boat needed.', localsSay: '', cost: 'Free + $10 rental', duration: '1–3 hrs', timeOfDay: 'Morning', fitReason: 'Boat-free reef access', location: 'Boca Catalina, Malmok', rating: 4.7, reviewCount: 0, adventure: 22, sections: ['beaches'], tags: [11912], matched_by: [] },
  { id: 'alto-vista-chapel', title: 'Alto Vista Chapel & Hilltop Walk', requires_car: true, category: 'Activities', image: '/Alto Vista Chapel.png', description: "Aruba's first chapel, alone on a hill above the north coast, reached by a lane lined with white crosses. Short walk, big view, and it empties out completely in the late afternoon.", localsSay: '', cost: 'Free', duration: '1–2 hrs', timeOfDay: 'Afternoon', fitReason: 'Quiet history, golden hour', location: 'Alto Vista, Noord', rating: 4.6, reviewCount: 0, adventure: 20, sections: ['culture-history'], tags: [11902], matched_by: [] },
  ...
  { id: 'bushiribana-loop', title: 'Bushiribana Ruins Coastal Loop', requires_car: true, category: 'Activities', image: '/Bushiribana ruins.jpg', description: 'The shell of a 19th-century gold smelter on the windward coast, with a rough loop along the cliffs from Calbas. Exposed, windy, and the sea here does not stop.', localsSay: '', cost: 'Free', duration: '2–3 hrs', timeOfDay: 'Morning', fitReason: 'Ruins and a wild coastline', location: 'Bushiribana, north coast', rating: 4.4, reviewCount: 0, adventure: 50, sections: ['adventures-outdoor'], tags: [11902], matched_by: [] },
  { id: 'san-nicolas-murals', title: 'San Nicolas Mural Walk', requires_car: true, category: 'Tours', image: '/San Nicolaas Mural.png', description: "The old refinery town turned open-air gallery — dozens of large-scale murals across a few walkable blocks, plus Aruba's oldest bars. Self-guided, or join a walking tour.", localsSay: '', cost: 'Free', duration: '2–3 hrs', timeOfDay: 'Morning', fitReason: 'Street art and real town life', location: 'San Nicolas', rating: 4.6, reviewCount: 0, adventure: 10, sections: ['culture-history'], matched_by: [] },
];
