...
- ~1,150 tests (`vitest run`, excluding any untracked `.claude/worktrees/` copy — that double-counts `src/data` and inflates the figure). `npm test` is offline and free EXCEPT for three
